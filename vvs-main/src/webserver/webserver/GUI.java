...
public class GUI {
    ...
    private void createGUI() {
        JFrame frmMyWebServer = new JFrame();
        ...
        topSection.setBackground(new Color(100, 149, 237));
        topSection.setAlignmentY(Component.BOTTOM_ALIGNMENT);
        ...
        frmMyWebServer.getContentPane().add(mainPanel, BorderLayout.NORTH);
        frmMyWebServer.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frmMyWebServer.addWindowListener(new WindowAdapter() {
            @Override
        ...
        frmMyWebServer.setTitle("My web server");
        frmMyWebServer.pack();
        frmMyWebServer.setVisible(true);
    }
    ...
    private JPanel createControlArea() {
        ...
        controlPanel.setBorder(BorderFactory.createTitledBorder("Oprire/Pornire server"));
        ...
        maintenanceModeCheck.setBackground(new Color(100, 149, 237));
    ...
    private JPanel createInfoArea() {
        ...
        infoPanel.setBackground(new Color(100, 149, 237));
    ...
    private JPanel createConfigArea() {
        ...
        configPanel.setBackground(new Color(100, 149, 237));
        configPanel.setBorder(BorderFactory.createTitledBorder("Configurarea Server-ului"));
        ...
        JPanel panel2 = new JPanel(new FlowLayout());
        panel2.setBackground(new Color(100, 149, 237));
        label = new JLabel("Root dir path: ");
        ...
        JPanel panel3 = new JPanel(new FlowLayout());
        panel3.setBackground(new Color(100, 149, 237));
        label = new JLabel("Maintenance dir path: ");
